...
echo "  Build: xcodebuild -scheme Cravey -destination 'platform=iOS Simulator,name=iPhone 17 Pro' | xcbeautify"
echo "  Test: xcodebuild test -scheme Cravey -destination 'platform=iOS Simulator,name=iPhone 17 Pro' | xcbeautify"
...
echo "  3. Code gets linted on build (SwiftLint); format with 'swiftformat .'"
