...
**Build Gate:** `bash scripts/verify.sh` ✅ (174 unit tests passing; add `--ui` for 22 UI tests)
...
| **Tests** | 46 files | 174 unit tests (Swift Testing) + 22 UI tests (XCTest), all passing |
...
| Date | Change |
|------|--------|
| 2026-01-31 | Test suite overhaul: DEBT-053–054 resolved, 174 unit tests (+35), TestConstants.swift added |
